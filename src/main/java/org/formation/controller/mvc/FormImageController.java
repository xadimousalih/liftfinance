...
import org.formation.dto.ImageInfo;
import org.formation.service.FilesStorageService;
  ...
  public String getListImages(Model model) {
    List<ImageInfo> imageInfos = storageService.loadAll().map(path -> {
      ...
      String url = MvcUriComponentsBuilder
          .fromMethodName(FormImageController.class, "getImage", path.getFileName().toString()).build().toString();
